...
document.addEventListener("DOMContentLoaded", function () {
    const loginField = document.querySelector('input#id_username');
    const passwordField = document.querySelector('input#id_password');

    if (loginField && passwordField) {
        loginField.value = "test_user";
        passwordField.value = "passwordfortest";
    }
});
